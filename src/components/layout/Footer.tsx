...
const socialLinks = [
  {
    name: 'LinkedIn',
    href: 'https://linkedin.com/in/lukecakalic',
    icon: (
  ...
  {
    name: 'Behance',
    href: 'https://behance.net/lukecakalic',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    name: 'Dribbble',
    href: 'https://dribbble.com/lukecakalic',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
              ...
              <div className="flex gap-4 mt-6">
                {socialLinks.map((social) => (
                  <a
                    ...
                    className="p-2 rounded-lg text-foreground-muted hover:text-foreground hover:bg-glass transition-all"
